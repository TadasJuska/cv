export const hero = {
  ...
  firstName: 'Tadas',
  lastName: 'Juška',
  bio: "DevOps, SRE, and Platform engineer with 10+ years of experience in multi-cloud infrastructure and AI-enabled systems across AWS, GCP, and Azure. Focused on Kubernetes, GitOps, IaC, zero-trust networking, and shipping production-grade agentic systems and MCP integrations that expose real system context to LLMs.",
...
export const experience = [
  {
    ...
    summary: 'Owned the platform end to end. Networking, cloud infrastructure, Kubernetes, and the delivery pipeline for every product team.',
    bullets: [
      'Re-architected the Kubernetes data plane: replaced kube-proxy with eBPF-based Cilium CNI, introduced an Envoy API gateway, and rolled out zero-trust encryption with WireGuard + ztunnel across all production clusters.',
      'Led the CI/CD migration from Jenkins to GitHub Actions and a GitOps model with ArgoCD + Kargo, moving releases from manual, ticket-driven deploys to promoted, auditable pipelines.',
      'Reduced AWS spend by about 30%. Moved provisioning to Karpenter with Spot capacity and consolidation, migrated workloads to Graviton/ARM64, bought Savings Plans, and scaled non-prod down outside working hours. Also switched to distroless multi-stage images, routed traffic through VPC endpoints to cut data transfer costs, and added ECR lifecycle policies.',
      'Parameterised Terraform modules with Terragrunt so onboarding a new customer was a single apply — no env duplication.',
      'Modernised the observability platform end to end — migrated legacy Prometheus deployments to the Prometheus Operator, codified Grafana dashboards and Alertmanager routing as code, re-engineered the Fluentd → Elasticsearch → Kibana log pipeline for structured logging and lifecycle retention, and integrated Sentry across all services, giving every team one source of truth for metrics, logs, and errors.',
      'Hardened security posture with least-privilege IAM, Cilium network policies, and image scanning in CI.',
      'Wrote runbooks and internal docs and paired with developers so product teams could self-serve on the platform instead of filing tickets.',
    ],
  },
  {
    ...
    clients: [
      {
        ...
        bullets: [
          'Operated a card data platform processing about 10M files per day for internal and external banking channels.',
          'Ran a containerd-based container environment for Java services, cron jobs, APIs, data lakes, and message queues.',
          'Led 4 engineers on platform architecture and delivery.',
          'Introduced Terraform and Ansible to a bank with no IaC, automating deployments and making scale-up low-maintenance.',
          'Owned TLS, LDAP, Kerberos, NTLM, and SSO. Led external security audits and coordinated remediation across partner teams.',
          'Built Zabbix with push/pull monitoring and incident-level triggers that paged on-call automatically.',
        ],
      },
      {
        ...
        bullets: [
          ...
          'Automated tasks with Python, Bash, Jenkins, and Azure Pipelines.',
    ...
    clients: [
      {
        ...
        bullets: [
          ...
          'Installed and maintained applications across Linux and Windows servers; handled hardware repairs, upgrades, and inventory.',
        ],
      },
      {
