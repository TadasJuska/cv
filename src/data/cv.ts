...
export const experience = [
  {
    ...
    bullets: [
      "Built the team's AI developer tooling by integrating Claude Code with Jira, Git, and MCP monitoring.",
      "Built RTK and Headroom, an MCP-native token optimization stack. Token use drops 60–95% before the LLM without hurting answer quality.",
      'Owned the platform end to end — network, infra, and the products running on top.',
      "Replaced kube-proxy with Cilium, added an Envoy API gateway, and rolled out WireGuard plus ztunnel zero-trust encryption in production Kubernetes.",
      "Shifted CI/CD from Jenkins to GitHub Actions with ArgoCD and Kargo GitOps. Teams ship their own code to AWS and on-prem through approved releases.",
      "Reduced AWS costs about 30% with Spot instances, Savings Plans, Graviton, rightsizing, overnight non-prod scaling, smaller Docker images, data-transfer tuning, and ECR lifecycle rules.",
      "Parameterised Terraform modules with Terragrunt so adding a new customer was a single apply.",
      "Established a shared observability stack: Prometheus plus Grafana for metrics, ELK for logs, Sentry for errors.",
    ],
  },
  {
